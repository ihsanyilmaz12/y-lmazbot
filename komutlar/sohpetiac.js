...
module.exports.run = async (bot, message, args) => {
        ...
        let rol15 = message.guild.roles.find('name', "Müzik Kapalı");
            ...
            sohpet.overwritePermissions(rol8, {'SEND_MESSAGES': true,})

            sohpet.overwritePermissions(rol9, {'SEND_MESSAGES': true,})
            sohpet.overwritePermissions(rol12, {'SEND_MESSAGES': true,})
            sohpet.overwritePermissions(rol13, {'SEND_MESSAGES': true,})
            sohpet.overwritePermissions(rol14, {'SEND_MESSAGES': true,})
            sohpet.overwritePermissions(rol15, {'SEND_MESSAGES': true,})

            sohpet.overwritePermissions(rol10, {'SEND_MESSAGES': true,})
            sohpet.overwritePermissions(rol11, {'SEND_MESSAGES': true,})
